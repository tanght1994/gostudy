...
func (x *RepHello) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RepHello) ProtoMessage() {}

func (x *RepHello) ProtoReflect() protoreflect.Message {
	mi := &file_pb_hello_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RepHello.ProtoReflect.Descriptor instead.
func (*RepHello) Descriptor() ([]byte, []int) {
	return file_pb_hello_proto_rawDescGZIP(), []int{1}
}

func (x *RepHello) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
var file_pb_hello_proto_rawDesc = []byte{
	...
	,
}
...
var file_pb_hello_proto_goTypes = []interface{}{
	(*ReqHello)(nil), // 0: ReqHello
	(*RepHello)(nil), // 1: RepHello
}
var file_pb_hello_proto_depIdxs = []int32{
	0, // 0: Greeter.SayHello:input_type -> ReqHello
	1, // 1: Greeter.SayHello:output_type -> RepHello
...
type GreeterClient interface {
	SayHello(ctx context.Context, in *ReqHello, opts ...grpc.CallOption) (*RepHello, error)
}
...
func (c *greeterClient) SayHello(ctx context.Context, in *ReqHello, opts ...grpc.CallOption) (*RepHello, error) {
	out := new(RepHello)
...
type GreeterServer interface {
	SayHello(context.Context, *ReqHello) (*RepHello, error)
}
...
func (*UnimplementedGreeterServer) SayHello(context.Context, *ReqHello) (*RepHello, error) {
...
func _Greeter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).SayHello(ctx, req.(*ReqHello))
	}
