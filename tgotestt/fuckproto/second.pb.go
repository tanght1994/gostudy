...
func (x *HelloReply) Reset() {
	*x = HelloReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_second_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*HelloReply) Descriptor() ([]byte, []int) {
	return file_proto_second_proto_rawDescGZIP(), []int{1}
}
...
var file_proto_second_proto_rawDesc = []byte{
	...
	0x32, 0xeb, 0x01, 0x0a, 0x07, 0x47, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72, 0x12, 0x28, 0x0a, 0x08,
	...
	0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x2b, 0x0a, 0x09, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c,
	0x6f, 0x31, 0x12, 0x0d, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x0b, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00,
	0x28, 0x01, 0x12, 0x2b, 0x0a, 0x09, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x32, 0x12,
	...
	0x2d, 0x0a, 0x09, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x33, 0x12, 0x0d, 0x2e, 0x48,
	0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0b, 0x2e, 0x48, 0x65,
	0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x18,
	0x5a, 0x16, 0x2e, 0x2f, 0x66, 0x75, 0x63, 0x6b, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x3b, 0x66,
	0x75, 0x63, 0x6b, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_proto_second_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_proto_second_proto_depIdxs = []int32{
	...
	0, // 2: Greeter.SayHello1:input_type -> HelloRequest
	0, // 3: Greeter.SayHello2:input_type -> HelloRequest
	0, // 4: Greeter.SayHello3:input_type -> HelloRequest
	1, // 5: Greeter.SayHello:output_type -> HelloReply
	1, // 6: Greeter.SayHelloAgain:output_type -> HelloReply
	1, // 7: Greeter.SayHello1:output_type -> HelloReply
	1, // 8: Greeter.SayHello2:output_type -> HelloReply
	1, // 9: Greeter.SayHello3:output_type -> HelloReply
...
func file_proto_second_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_second_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
